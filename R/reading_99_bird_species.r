...
reading_99_bird_species <- function() {
   ...
   if (!file.exists('./data/downloaded_data/traits/99_bird_species_data-02-00012-s001/Table 1.csv')) {
      ...
      unzip(zipfile = './data/cache/traits/data-02-00012-s001.zip',
            exdir = './data/downloaded_data/traits/99_bird_species_data-02-00012-s001')
   ...
   return(
      list(
         measured = data.table::fread('./data/downloaded_data/traits/99_bird_species_data-02-00012-s001/Table 1.csv', sep = ';', dec = '.', header = TRUE, na.strings = 'n/a'),
         compiled = data.table::fread('./data/downloaded_data/traits/99_bird_species_data-02-00012-s001/Table 2.csv', sep = ';', dec = '.', header = TRUE, na.strings = 'n/a')
      )
   )
