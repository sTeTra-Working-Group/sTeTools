...
reading_COMBINE <- function() {
   ...
   if (!file.exists('./data/downloaded_data/traits/COMBINE_10.1002_ecy.3344_1/MetadataS1.pdf')) {
      ...
      unzip(zipfile = './data/cache/traits/COMBINE_10.1002_ecy.3344_1.zip',
            exdir = './data/downloaded_data/traits/COMBINE_10.1002_ecy.3344_1')

      unzip(zipfile = './data/downloaded_data/traits/COMBINE_10.1002_ecy.3344_1/ecy3344-sup-0001-datas1.zip',
            exdir = './data/downloaded_data/traits/COMBINE_10.1002_ecy.3344_1')
      file.remove('./data/downloaded_data/traits/COMBINE_10.1002_ecy.3344_1/ecy3344-sup-0001-datas1.zip')
   }

   # reading the csv
   return(
      data.table::fread('./data/downloaded_data/traits/COMBINE_10.1002_ecy.3344_1/COMBINE_archives/trait_data_imputed.csv', sep = ',', dec = '.', header = TRUE)
   )
}
